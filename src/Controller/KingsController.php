...
class KingsController extends BaseController
{
    ...
    #[Route('/kings', name: 'add_kings', methods: ['POST'])]
    public function addKings(#[MapRequestPayload(type: AddKingRequestDTO::class)] array $request): Response
    {
        $addKingsRequestDTO = new AddKingsRequestDTO();
        $addKingsRequestDTO->kings = $request;

        $this->kingsService->addKings($addKingsRequestDTO);
